 ...
 * org.springframework.web.multipart.MaxUploadSizeExceededException; import
 * org.springframework.web.servlet.mvc.method.annotation.
 * ResponseEntityExceptionHandler;
 * 
 * import com.spring.security.message.ResponseMessage;
 * 
 * @ControllerAdvice public class FileUploadExceptionAdvice extends
 * ResponseEntityExceptionHandler {
 * 
 * @ExceptionHandler(MaxUploadSizeExceededException.class) public
 * ResponseEntity<?> handleMaxSizeException(MaxUploadSizeExceededException exc)
